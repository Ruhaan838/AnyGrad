...
class Tensor:
    ...
    def __init__(self, data:List[int|float] | Tuple[int|float], 
        ...
        type_list = Th.ValidDataType()(data)
        if dtype == Th.bool:
    ...
    def __getitem__(self, index:Union[int, slice]) -> 'Tensor': return self._tensor.__getitem__(index)
    ...
    def __neg__(self) -> 'Tensor': return self._tensor.__neg__()
